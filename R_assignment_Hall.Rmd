...
ggplot(data = fang_genotypes_long) + geom_bar(mapping = aes(x = Group, fill= zygosity), position = 'fill') + theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1)) 

#plot zygosity based on sample
